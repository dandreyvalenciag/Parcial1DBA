...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "CLIENTES_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 NOCACHE  NOORDER  NOCYCLE
--------------------------------------------------------
--  DDL for Sequence FABRICANTES_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "FABRICANTES_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 30000 NOCACHE  NOORDER  NOCYCLE
--------------------------------------------------------
--  DDL for Sequence FACTURAS_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "FACTURAS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 55000 NOCACHE  NOORDER  NOCYCLE
--------------------------------------------------------
--  DDL for Sequence INTERCAMBIOS_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "INTERCAMBIOS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 900 NOCACHE  NOORDER  NOCYCLE
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "MODELOS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 400 NOCACHE  NOORDER  NOCYCLE
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "OPCIONES_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 800 NOCACHE  NOORDER  NOCYCLE
--------------------------------------------------------
--  DDL for Sequence OPCIONES_VENTAS_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "OPCIONES_VENTAS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 700 NOCACHE  NOORDER  NOCYCLE
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "VEHICULOS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 20000 NOCACHE  NOORDER  NOCYCLE
--------------------------------------------------------
--  DDL for Sequence VENDEDORES_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "VENDEDORES_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 100 NOCACHE  NOORDER  NOCYCLE
--------------------------------------------------------
--  DDL for Sequence VENTAS_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "VENTAS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 45000 NOCACHE  NOORDER  NOCYCLE
REM INSERTING into ANSWERS
SET DEFINE OFF;
Insert into ANSWERS (ID,NUMBER_OF_QUESTION,ANSWER) values ('1','QUESTION 1','21');
