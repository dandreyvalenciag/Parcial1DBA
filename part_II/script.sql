...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "ACCOUNTS_SEQUENCE"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 20201 NOCACHE  NOORDER  NOCYCLE
--------------------------------------------------------
--  DDL for Sequence CLIENTES_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "CLIENTES_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 NOCACHE  NOORDER  NOCYCLE
--------------------------------------------------------
--  DDL for Sequence CUSTOMER_SEQUENCE
--------------------------------------------------------

   CREATE SEQUENCE  "CUSTOMER_SEQUENCE"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 298 NOCACHE  NOORDER  NOCYCLE
--------------------------------------------------------
--  DDL for Sequence FABRICANTES_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "FABRICANTES_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 30005 NOCACHE  NOORDER  NOCYCLE
--------------------------------------------------------
--  DDL for Sequence FACTURAS_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "FACTURAS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 55016 NOCACHE  NOORDER  NOCYCLE
--------------------------------------------------------
--  DDL for Sequence INTERCAMBIOS_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "INTERCAMBIOS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 911 NOCACHE  NOORDER  NOCYCLE
--------------------------------------------------------
--  DDL for Sequence LOCATION_SEQUENCE
--------------------------------------------------------

   CREATE SEQUENCE  "LOCATION_SEQUENCE"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 5011 NOCACHE  NOORDER  NOCYCLE
--------------------------------------------------------
--  DDL for Sequence MODELOS_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "MODELOS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 404 NOCACHE  NOORDER  NOCYCLE
--------------------------------------------------------
--  DDL for Sequence OPCIONES_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "OPCIONES_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 804 NOCACHE  NOORDER  NOCYCLE
--------------------------------------------------------
--  DDL for Sequence OPCIONES_VENTAS_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "OPCIONES_VENTAS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 704 NOCACHE  NOORDER  NOCYCLE
--------------------------------------------------------
--  DDL for Sequence VEHICULOS_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "VEHICULOS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 20052 NOCACHE  NOORDER  NOCYCLE
--------------------------------------------------------
--  DDL for Sequence VENDEDORES_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "VENDEDORES_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 111 NOCACHE  NOORDER  NOCYCLE
--------------------------------------------------------
--  DDL for Sequence VENTAS_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "VENTAS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 45020 NOCACHE  NOORDER  NOCYCLE
...
--------------------------------------------------------
  ...
  ALTER TABLE "CATEGORIES" ADD CONSTRAINT "CK_SEASON_TYPE" CHECK (SEASON IN ('winter', 'summer', 'spring', 'autumn')) ENABLE
...
--------------------------------------------------------
  ...
  ALTER TABLE "PRODUCTS" ADD CONSTRAINT "CK_PRICE_POSITIVE" CHECK (PRICE > 0) ENABLE
